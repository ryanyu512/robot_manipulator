...
int main(int argc, char** argv)
{
  ...
  // are used interchangably.
    ...
    ROS_INFO_NAMED("tutorial", "move to home position (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "place the TCP above the target (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Open gripper (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Move the TCP close to the object (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Close gripper (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Move the TCP above the plate (pose goal) %s", success ? "SUCCEED" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Lower the TCP above the plate (pose goal) %s", success ? "SUCCEED" : "FAILED");
